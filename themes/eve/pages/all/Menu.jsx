    ...
    <div className="main-menu self-center hidden md:block">
      <ul className="nav flex space-x-275 justify-content-center">
        <li className="nav-item">
          <a className="nav-link hover:underline" href={"/page/apropos"}>
            À propos
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link hover:underline" href={"/page/portfolio"}>
            Portfolio
          </a>
        </li>
        {items.map((i, index) => (
        ...
        <li className="nav-item">
          <a className="nav-link hover:underline" href={"/page/questions"}>
