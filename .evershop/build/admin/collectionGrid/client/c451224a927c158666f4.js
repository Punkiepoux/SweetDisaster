...
(() => {
  var l = {
    ...
    15309: (t, n, r) => {
      ...
      C.propTypes = { text: i().string.isRequired };
      function O(e) {
        var { title: t } = e;
        return o.createElement(
          "th",
      ...
      var L = r.n(_);
      var P = r(23678);
      const I = "FORM_VALIDATED";
      const M = "FORM_SUBMIT";
      const R = "FORM_FIELD_UPDATED";
      var j = r(31021);
      var F = r(64600);
      const Z = {};
      const V = {
      ...
      function X(e) {
        ...
        var C = () => {
          ...
          if (Object.keys(e).length === 0) {
            h(m.map((e) => Y(Y({}, e), {}, { error: undefined })));
          } else {
            h(
              m.map((t) => {
                if (!e[t.name]) {
        ...
        var O = async (o) => {
          ...
          try {
            ...
            var f = C();
            L().publishSync(I, { formId: t, errors: f });
            if (Object.keys(f).length === 0) {
              ...
              var p = await fetch(n, {
                ...
                body:
                  a === true
                    ? JSON.stringify((0, j.serializeForm)(d.entries(), v))
                    : d,
                headers: Y(
              ...
              var m = await p.json();
              if ((0, P.get)(m, "data.redirectUrl") !== undefined) {
      ...
      var G = () => o.useContext(q);
      var $ = () => React.useContext(H);
      var J = r(30115);
      var Q = r.n(J);
      var K = [
        "onChange",
      ...
      var ge = {
        ...
        F: function (e, t, n) {
          return ve(ge.n(e, t, n) - 1, false, t);
        },
        G: function (e, t, n) {
      ...
      var De = 300;
      function _e(t, n) {
        var r = { config: Se(Se({}, ee), Pe.defaultConfig), l10n: ne };
        ...
        function y() {
          ...
          if (window.ontouchstart !== undefined)
            h(window.document, "touchstart", W);
          else h(window.document, "mousedown", W);
          h(window.document, "focus", W, { capture: true });
        ...
        function k() {
          ...
          r.calendarContainer = se("div", "flatpickr-calendar");
          r.calendarContainer.tabIndex = -1;
          if (!r.config.noCalendar) {
            e.appendChild(P());
            r.innerContainer = se("div", "flatpickr-innerContainer");
            ...
            r.rContainer = se("div", "flatpickr-rContainer");
            r.rContainer.appendChild(M());
            if (!r.daysContainer) {
              r.daysContainer = se("div", "flatpickr-days");
        ...
        function x(e, t, n, a) {
          var i = B(t, true),
            o = se("span", e, t.getDate().toString());
          o.dateObj = t;
          o.$i = a;
          o.setAttribute(
            "aria-label",
        ...
        function D() {
          ...
          for (var t = 0; t < 12; t++) {
            if (!e(t)) continue;
            var n = se("option", "flatpickr-monthDropdown-month");
        ...
        function P() {
          r.monthNav = se("div", "flatpickr-months");
          r.yearElements = [];
          r.monthElements = [];
          r.prevMonthNav = se("span", "flatpickr-prev-month");
          r.prevMonthNav.innerHTML = r.config.prevArrow;
          r.nextMonthNav = se("span", "flatpickr-next-month");
        ...
        function I() {
          ...
          var e = Oe(r.config);
          r.timeContainer = se("div", "flatpickr-time");
          r.timeContainer.tabIndex = -1;
          var t = se("span", "flatpickr-time-separator", ":");
          ...
          if (r.config.enableSeconds) {
            ...
            r.timeContainer.appendChild(
              se("span", "flatpickr-time-separator", ":")
            );
        ...
        function M() {
          if (!r.weekdayContainer)
            r.weekdayContainer = se("div", "flatpickr-weekdays");
        ...
        function j() {
          ...
          e.appendChild(
            se("span", "flatpickr-weekday", r.l10n.weekAbbreviation)
          );
        ...
        function te() {
          ...
          var a = Se(Se({}, JSON.parse(JSON.stringify(t.dataset || {}))), n);
          var i = {};
          ...
          if (!a.dateFormat && (a.enableTime || o)) {
            var s = Pe.defaultConfig.dateFormat || ee.dateFormat;
            i.dateFormat =
              a.noCalendar || o
          ...
          if (a.altInput && (a.enableTime || o) && !a.altFormat) {
            var u = Pe.defaultConfig.altFormat || ee.altFormat;
            i.altFormat =
              a.noCalendar || o
          ...
          K.filter(function (e) {
            ...
            r.config[e] = oe(r.config[e] || []).map(l);
          });
          r.isMobile =
          ...
          for (var f = 0; f < r.config.plugins.length; f++) {
            ...
            for (var p in d) {
              if (K.indexOf(p) > -1) {
                r.config[p] = oe(d[p]).map(l).concat(r.config[p]);
        ...
        function me() {
          if (
            ...
            typeof Pe.l10ns[r.config.locale] === "undefined"
          )
          ...
          he.K =
            ...
            ")";
          var e = Se(Se({}, n), JSON.parse(JSON.stringify(t.dataset || {})));
          if (
        ...
        function ge(e) {
          ...
          le(r.calendarContainer, "arrowLeft", !p && !v);
          le(r.calendarContainer, "arrowCenter", p);
          le(r.calendarContainer, "arrowRight", v);
          var m =
          ...
          le(r.calendarContainer, "rightMost", h);
        ...
        function ze() {
          ...
          if (r.config.altInput) {
            r.altInput = se(r.input.nodeName, r.config.altInputClass);
            r._input = r.altInput;
        ...
        function We() {
          var e = r.config.enableTime
            ? r.config.noCalendar
              ...
              : "datetime-local"
            : "date";
          r.mobileInput = se("input", r.input.className + " flatpickr-mobile");
      ...
      Pe.defaultConfig = {};
      Pe.l10ns = { en: Se({}, ne), default: Se({}, ne) };
      Pe.localize = function (e) {
        Pe.l10ns.default = Se(Se({}, Pe.l10ns.default), e);
      };
      Pe.setDefaults = function (e) {
        Pe.defaultConfig = Se(Se({}, Pe.defaultConfig), e);
      };
      Pe.parseDate = be({});
      Pe.formatDate = ye({});
      Pe.compareDates = Ee;
      ...
      Fe.defaultProps = { value: undefined, error: undefined };
      ...
      var qe = (e) => typeof e === "boolean";
      var He = (e) => (qe(e) ? e : parseInt(e, 10) === 1);
      var Xe = (e) => (qe(e) ? e : parseInt(e, 10) || 0);
      var Ge = (e) => {
        if (qe(e)) {
          return !e;
        }
      ...
      function $e(e) {
        ...
        return o.createElement(
          ...
          { className: "form-field-container ".concat(i ? "has-error" : null) },
          r && o.createElement("label", { htmlFor: t }, r),
          o.createElement("input", { type: "hidden", value: +Xe(s), name: t }),
          o.createElement(
            "div",
            { className: "field-wrapper flex flex-grow" },
            He(s) && o.createElement(Ue, { onClick: () => c() }),
            !He(s) && o.createElement(Be, { onClick: () => c() })
          ),
          l &&
            o.createElement("div", { className: "field-instruction mt-sm" }, l),
          o.createElement(m.A, { error: i })
      ...
      function nt(e) {
        ...
        o.useEffect(() => {
          L().publishSync(R, { name: t, value: s });
        }, [s]);
        var d = (n) => {
          var i;
        ...
        return o.createElement(
          p,
          et({}, e, { onChange: d, value: s, error: f ? f.error : undefined })
        );
      }
      nt.propTypes = {
        name: i().string.isRequired,
                      ...
                      coreComponents: [
                        {
                          component: {
                            default: () =>
                              o.createElement(C, { text: e.collectionId }),
                          },
                          sortOrder: 5,
                        },
                        {
                        ...
                        {
                          component: {
                            default: () => o.createElement(C, { text: e.code }),
                          },
                          sortOrder: 15,
                        },
                      ],
    ...
    79676: (e, t, n) => {
      ...
      l.propTypes = { newCollectionUrl: a().string.isRequired };
      var s =
