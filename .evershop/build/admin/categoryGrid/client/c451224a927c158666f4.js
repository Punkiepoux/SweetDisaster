...
(() => {
  var l = {
    ...
    9369: (t, n, r) => {
      "use strict";
      r.r(n);
      r.d(n, { default: () => it, query: () => ot, variables: () => lt });
      var a = r(5556);
      var i = r.n(a);
      var o = r(96540);
      var l = r(72505);
      ...
      function N(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              "a",
              { className: "hover:underline font-semibold", href: t.editUrl },
              t.path.map((e) => e.name).join(" / ")
            )
          )
        );
      }
      N.propTypes = {
        category: i().shape({
          ...
          path: i().arrayOf(i().shape({ name: i().string.isRequired }))
            .isRequired,
        }).isRequired,
      };
      var C = r(96044);
      ...
      _.defaultProps = { currentFilters: [] };
      var P = r(23224);
      var L = r.n(P);
      var I = r(23678);
      const M = "FORM_VALIDATED";
      const R = "FORM_SUBMIT";
      const j = "FORM_FIELD_UPDATED";
      var F = r(31021);
      var Z = r(64600);
      const V = {};
      const Y = {
      ...
      function G(e) {
        ...
        var C = () => {
          ...
          if (Object.keys(e).length === 0) {
            h(m.map((e) => U(U({}, e), {}, { error: undefined })));
          } else {
            h(
              m.map((t) => {
                if (!e[t.name]) {
        ...
        var O = async (o) => {
          ...
          w("submitting");
          try {
            L().publishSync(R, { props: e });
            var f = C();
            L().publishSync(M, { formId: t, errors: f });
            if (Object.keys(f).length === 0) {
              ...
              var p = await fetch(n, {
                ...
                body:
                  a === true
                    ? JSON.stringify((0, F.serializeForm)(d.entries(), v))
                    : d,
                headers: U(
              ...
              var m = await p.json();
              if ((0, I.get)(m, "data.redirectUrl") !== undefined) {
      ...
      function fe(e, t) {
        if (t(e)) return e;
        else if (e.parentNode) return fe(e.parentNode, t);
        return undefined;
      }
      function de(e, t) {
      ...
      var he = {
        ...
        K: function (e, t, n) {
          e.setHours(
            (e.getHours() % 12) + 12 * ie(new RegExp(n.amPM[1], "i").test(t))
          );
        },
        M: function (e, t, n) {
      ...
      var ye = {
        ...
        D: function (e, t, n) {
          return t.weekdays.shorthand[ye.w(e, t, n)];
        },
        F: function (e, t, n) {
          return me(ye.n(e, t, n) - 1, false, t);
        },
        G: function (e, t, n) {
          return ae(ye.h(e, t, n));
        },
        H: function (e) {
          return ae(e.getHours());
        },
        J: function (e, t) {
        ...
        K: function (e, t) {
          return t.amPM[ie(e.getHours() > 11)];
        },
        M: function (e, t) {
          return me(e.getMonth(), true, t);
        },
        S: function (e) {
          return ae(e.getSeconds());
        },
        U: function (e) {
      ...
      var _e = 300;
      function Pe(t, n) {
        var r = { config: De(De({}, te), Ie.defaultConfig), l10n: re };
        ...
        function c(e, t) {
          return (e % 12) + 12 * ie(t === r.l10n.amPM[1]);
        }
        function f(e) {
          switch (e % 24) {
            case 0:
        ...
        function v(e, t, n) {
          ...
          r.hourElement.value = ae(
            !r.config.time_24hr ? ((12 + e) % 12) + 12 * ie(e % 12 === 0) : e
          );
          r.minuteElement.value = ae(t);
          if (r.amPM !== undefined)
            r.amPM.textContent = r.l10n.amPM[ie(e >= 12)];
          if (r.secondElement !== undefined) r.secondElement.value = ae(n);
        }
        function m(e) {
          var t = pe(e);
        ...
        function k() {
          ...
          r.calendarContainer = ue("div", "flatpickr-calendar");
          r.calendarContainer.tabIndex = -1;
          if (!r.config.noCalendar) {
            e.appendChild(L());
            r.innerContainer = ue("div", "flatpickr-innerContainer");
            ...
            r.rContainer = ue("div", "flatpickr-rContainer");
            r.rContainer.appendChild(M());
            if (!r.daysContainer) {
              r.daysContainer = ue("div", "flatpickr-days");
          ...
          if (r.config.inline || r.config.static) {
            ...
            if (r.config.static) {
              var o = ue("div", "flatpickr-wrapper");
        ...
        function x(e, t, n, a) {
          var i = q(t, true),
            o = ue("span", e, t.getDate().toString());
          o.dateObj = t;
          o.$i = a;
          o.setAttribute(
            "aria-label",
        ...
        function T(e, t) {
          var n = o();
          var a = B(n || document.body);
          var i =
            e !== undefined
              ? e
              : a
              ? n
              : r.selectedDateElem !== undefined && B(r.selectedDateElem)
              ? r.selectedDateElem
              : r.todayDateElem !== undefined && B(r.todayDateElem)
              ? r.todayDateElem
              : C(t > 0 ? 1 : -1);
          if (i === undefined) {
            r._input.focus();
        ...
        function D() {
          ...
          ce(r.daysContainer);
          if (r.weekNumbers) ce(r.weekNumbers);
        ...
        function A() {
          ...
          for (var t = 0; t < 12; t++) {
            if (!e(t)) continue;
            var n = ue("option", "flatpickr-monthDropdown-month");
            n.value = new Date(r.currentYear, t).getMonth().toString();
            n.textContent = me(t, r.config.shorthandCurrentMonth, r.l10n);
            n.tabIndex = -1;
            if (r.currentMonth === t) {
              n.selected = true;
            }
        ...
        function _() {
          ...
          var o = ue("div", "flatpickr-current-month");
          o.appendChild(n);
          o.appendChild(a);
          t.appendChild(o);
          e.appendChild(t);
        ...
        function L() {
          r.monthNav = ue("div", "flatpickr-months");
          r.yearElements = [];
          r.monthElements = [];
          r.prevMonthNav = ue("span", "flatpickr-prev-month");
          r.prevMonthNav.innerHTML = r.config.prevArrow;
          r.nextMonthNav = ue("span", "flatpickr-next-month");
        ...
        function I() {
          ...
          var e = Te(r.config);
          r.timeContainer = ue("div", "flatpickr-time");
          r.timeContainer.tabIndex = -1;
          var t = ue("span", "flatpickr-time-separator", ":");
          var n = de("flatpickr-hour", { "aria-label": r.l10n.hourAriaLabel });
          r.hourElement = n.getElementsByTagName("input")[0];
          var a = de("flatpickr-minute", {
          ...
          if (r.config.enableSeconds) {
            ...
            var i = de("flatpickr-second");
            r.secondElement = i.getElementsByTagName("input")[0];
            r.secondElement.value = ae(
              r.latestSelectedDateObj
            ...
            r.timeContainer.appendChild(
              ue("span", "flatpickr-time-separator", ":")
            );
        ...
        function M() {
          if (!r.weekdayContainer)
            r.weekdayContainer = ue("div", "flatpickr-weekdays");
          else ce(r.weekdayContainer);
          for (var e = r.config.showMonths; e--; ) {
        ...
        function R() {
          ...
          var t = Ae(r.l10n.weekdays.shorthand);
          if (e > 0 && e < t.length) {
            t = Ae(t.splice(e, t.length), t.splice(0, e));
          }
        ...
        function j() {
          ...
          e.appendChild(
            ue("span", "flatpickr-weekday", r.l10n.weekAbbreviation)
          );
        ...
        function H(e) {
          ...
          if (t && n && !(e.relatedTarget && z(e.relatedTarget))) {
            r.setDate(
              r._input.value,
              true,
        ...
        function G(e, t) {
          ...
          f.forEach(function (t) {
            ...
            if (e !== undefined) {
              ...
              if (o >= s && (u === 0 || o <= u) && xe(o, a, n))
                t.classList.add("inRange");
            }
          });
        }
        function $() {
          if (r.isOpen && !r.config.static && !r.config.inline) he();
        }
        function Q(e, t) {
          if (t === void 0) {
        ...
        function K() {
          ...
          var a = De(De({}, JSON.parse(JSON.stringify(t.dataset || {}))), n);
          var i = {};
          ...
          if (!a.dateFormat && (a.enableTime || o)) {
            var s = Ie.defaultConfig.dateFormat || te.dateFormat;
            i.dateFormat =
              a.noCalendar || o
          ...
          if (a.altInput && (a.enableTime || o) && !a.altFormat) {
            var u = Ie.defaultConfig.altFormat || te.altFormat;
            i.altFormat =
              a.noCalendar || o
          ...
          ee.filter(function (e) {
            ...
            r.config[e] = le(r.config[e] || []).map(l);
          });
          r.isMobile =
          ...
          for (var f = 0; f < r.config.plugins.length; f++) {
            ...
            for (var p in d) {
              if (ee.indexOf(p) > -1) {
                r.config[p] = le(d[p]).map(l).concat(r.config[p]);
              } else if (typeof a[p] === "undefined") r.config[p] = d[p];
            }
          }
          if (!a.altInputClass) {
            r.config.altInputClass =
              ne().className + " " + r.config.altInputClass;
          }
          qe("onParseConfig");
        }
        function ne() {
        ...
        function ve() {
          ...
          ge.D = "(" + r.l10n.weekdays.shorthand.join("|") + ")";
          ge.l = "(" + r.l10n.weekdays.longhand.join("|") + ")";
          ge.M = "(" + r.l10n.months.shorthand.join("|") + ")";
          ge.F = "(" + r.l10n.months.longhand.join("|") + ")";
          ge.K =
            "(" +
            r.l10n.amPM[0] +
            "|" +
            ...
            ")";
          var e = De(De({}, n), JSON.parse(JSON.stringify(t.dataset || {})));
          if (
        ...
        function he(e) {
          ...
          se(r.calendarContainer, "arrowLeft", !p && !v);
          se(r.calendarContainer, "arrowCenter", p);
          se(r.calendarContainer, "arrowRight", v);
          var m =
          ...
          se(r.calendarContainer, "rightMost", h);
        ...
        function Re(e, t) {
          if (e !== null && typeof e === "object") {
            ...
            else if (ee.indexOf(e) > -1) r.config[e] = le(t);
          }
          r.redraw();
          Qe(true);
        }
        ...
        function Ye() {
          ...
          if (r.config.altInput) {
            r.altInput = ue(r.input.nodeName, r.config.altInputClass);
            r._input = r.altInput;
        ...
        function Ue() {
          var e = r.config.enableTime
            ? r.config.noCalendar
              ...
              : "datetime-local"
            : "date";
          r.mobileInput = ue("input", r.input.className + " flatpickr-mobile");
          ...
          h(r.mobileInput, "change", function (e) {
            r.setDate(pe(e).value, false, r.mobileFormatStr);
            qe("onChange");
            qe("onClose");
          });
        }
          ...
          r.yearElements.forEach(function (e, t) {
            ...
            if (
              ...
              r.monthElements[t].textContent =
                me(n.getMonth(), r.config.shorthandCurrentMonth, r.l10n) + " ";
            } else {
        ...
        function Ke(e) {
          ...
          if (r.amPM !== undefined && n === r.amPM) {
            r.amPM.textContent =
              r.l10n.amPM[ie(r.amPM.textContent === r.l10n.amPM[0])];
          }
          ...
          if (typeof a.value !== "undefined" && a.value.length === 2) {
            var f = a === r.hourElement,
              d = a === r.minuteElement;
            if (c < i) {
              c = o + c + ie(!f) + (ie(f) && ie(!r.amPM));
              if (d) w(undefined, -1, r.hourElement);
            } else if (c > o) {
              c = a === r.hourElement ? c - o - ie(!r.amPM) : i;
              if (d) w(undefined, 1, r.hourElement);
            }
      ...
      Ie.defaultConfig = {};
      Ie.l10ns = { en: De({}, re), default: De({}, re) };
      Ie.localize = function (e) {
        Ie.l10ns.default = De(De({}, Ie.l10ns.default), e);
      };
      Ie.setDefaults = function (e) {
        Ie.defaultConfig = De(De({}, Ie.defaultConfig), e);
      };
      Ie.parseDate = Ee({});
      Ie.formatDate = be({});
      Ie.compareDates = we;
      ...
      var je = o.forwardRef((e, t) => {
        ...
        var d = t || o.createRef();
        o.useEffect(() => {
          var e = Re(d.current, { enableTime: false });
      ...
      var Fe = o.forwardRef((e, t) => {
        ...
        var d = t || o.createRef();
        o.useEffect(() => {
          var e = Re(d.current, { enableTime: true });
          e.config.onChange.push((e, t) => {
            if (i) i.call(window, t);
          });
        }, []);
      ...
      Ze.defaultProps = { value: undefined, error: undefined };
      ...
      var Xe = (e) => (He(e) ? e : parseInt(e, 10) === 1);
      var Ge = (e) => (He(e) ? e : parseInt(e, 10) || 0);
      var $e = (e) => {
        if (He(e)) {
          return !e;
        }
      ...
      function Qe(e) {
        ...
        return o.createElement(
          ...
          { className: "form-field-container ".concat(i ? "has-error" : null) },
          r && o.createElement("label", { htmlFor: t }, r),
          o.createElement("input", { type: "hidden", value: +Ge(s), name: t }),
          o.createElement(
            "div",
            { className: "field-wrapper flex flex-grow" },
            Xe(s) && o.createElement(qe, { onClick: () => c() }),
            !Xe(s) && o.createElement(Be, { onClick: () => c() })
          ),
          l &&
            o.createElement("div", { className: "field-instruction mt-sm" }, l),
          o.createElement(m.A, { error: i })
      ...
      function rt(e) {
        ...
        o.useEffect(() => {
          L().publishSync(j, { name: t, value: s });
        }, [s]);
        var d = (n) => {
          var i;
        ...
        return o.createElement(
          p,
          tt({}, e, { onChange: d, value: s, error: f ? f.error : undefined })
        );
      }
      rt.propTypes = {
        name: i().string.isRequired,
      ...
      rt.defaultProps = { onChange: undefined, validationRules: [], value: "" };
      function at(e) {
        var { categories: t = [], selectedIds: n = [] } = e;
        var { openAlert: r, closeAlert: a } = (0, b.Z)();
        var [i, l] = (0, o.useState)(false);
        var u = async () => {
          l(true);
          var e = t
            .filter((e) => n.includes(e.uuid))
            .map((e) => s()["delete"](e.deleteApi));
          await Promise.all(e);
          l(false);
        ...
        var c = [
          {
            ...
            onAction: () => {
              r({
                heading: "Delete ".concat(n.length, " categories"),
      ...
      at.propTypes = {
        ...
        categories: i().arrayOf(i().shape({ uuid: i().string.isRequired }))
          .isRequired,
      };
      function it(e) {
        var t;
        var {
          categories: { items: n, total: r, currentFilters: a = [] },
        } = e;
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    o.createElement(k, {
                      ...
                      onChange: (t) => {
                        if (t.target.checked) c(s.concat([e.uuid]));
                        else c(s.filter((t) => t !== e.uuid));
                      },
                    })
                  ),
                  o.createElement(u.A, {
                    ...
                    coreComponents: [
                      {
                        component: {
                          default: () =>
                            o.createElement(N, { id: "name", category: e }),
                        },
                        sortOrder: 10,
                      },
                      {
      ...
      it.propTypes = {
        categories: i().shape({
          items: i().arrayOf(
            i().shape({
              categoryId: i().number.isRequired,
              uuid: i().string.isRequired,
              name: i().string.isRequired,
              status: i().number.isRequired,
              includeInNav: i().number.isRequired,
              editUrl: i().string.isRequired,
    ...
    69024: (e, t, n) => {
      ...
      const c = u;
      function f() {
        return r.createElement(c, { backUrl: null, heading: "Categories" });
      }
    },
    48256: (e, t, n) => {
      "use strict";
      ...
      var o = n(64600);
      function l(e) {
        var { newCateoryUrl: t } = e;
        return i.createElement(o.A, { url: t, title: "New Category" });
      }
      l.propTypes = { newCateoryUrl: a().string.isRequired };
      var s =
    ...
    22551: (t, r, i) => {
      ...
      function Pt(e) {
        ...
        for (var t = e.targetContainers; 0 < t.length; ) {
          ...
          if (null !== n)
            return (t = Pa(n)), null !== t && mt(t), (e.blockedOn = n), !1;
          t.shift();
        }
        return !0;
      }
      ...
      var Tn = {
        ...
        In = l({}, Dn, {
          ...
          movementX: function (e) {
            ...
            e !== Ln &&
              (Ln && "mousemove" === e.type
                ? ((_n = e.screenX - Ln.screenX), (Pn = e.screenY - Ln.screenY))
                : (Pn = _n = 0),
              (Ln = e));
            return _n;
          },
      ...
      function _r() {
        kr && (kr.detachEvent("onpropertychange", Pr), (xr = kr = null));
      }
      function Pr(e) {
      ...
      function Lr(e, t, n) {
        "focusin" === e
          ? (_r(), (kr = t), (xr = n), kr.attachEvent("onpropertychange", Pr))
          : "focusout" === e && _r();
      }
      function Ir(e) {
      ...
      function jl(e, t, n) {
        ...
        switch (t.tag) {
          ...
          case 4:
            return (
              uo(), Ll(t), null === e && oa(t.stateNode.containerInfo), null
            );
          case 10:
            return Pi(t), null;
          case 17:
      ...
      var zu = { Events: [Pa, La, Ia, Ye, ze, fu, { current: !1 }] },
        Uu = {
    ...
    66474: (e, t, n) => {
      ...
      var I = function e(t) {
        ...
        return (0, r.createElement)(
          ...
          (0, r.createElement)(
            "div",
            Object.assign({ id: A, onClick: p, className: M || undefined }, u, {
              style: w,
              ref: s,
            }),
            (0, r.createElement)(
            ...
            return (0, r.createElement)(
              ...
              t.map(function (e) {
                var t = e.content,
                  n = e.props;
                return (0,
                r.createElement)(I, Object.assign({}, n, { in: o(n.toastId), key: "toast-" + n.key, closeButton: n.closeButton === true ? P : n.closeButton }), t);
              })
            );
          })
        );
    ...
    7463: (e, t) => {
      ...
      t.unstable_scheduleCallback = function (e, i, o) {
        ...
        o > l
          ...
          : ((e.sortIndex = s), x(T, e), L || P || ((L = !0), n(j)));
        return e;
      };
    ...
    16535: (e, t, n) => {
      ...
      var q,
        ...
        Q = H
          ...
          : (((q = {})["immer-nothing"] = !0), q),
        J = H ? Symbol.for("immer-draftable") : "__$immer_draftable",
