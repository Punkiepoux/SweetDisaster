...
(() => {
  var l = {
    ...
    71369: (t, n, r) => {
      ...
      function Qe(e) {
        return ye(Ke("", null, null, null, [""], (e = ge(e)), 0, [0], e));
      }
      ...
      function ht(e, t) {
        switch (U(e, t)) {
          ...
          case 4949:
            if ($(e, t + 1) !== 115) break;
          case 6444:
            switch ($(e, Q(e) - 3 - (~X(e, "!important") && 10))) {
              case 107:
                return G(e, ":", ":" + De) + e;
              case 101:
                return (
      ...
      var wn = rn(function (e, t, n) {
        ...
        var c = {};
        for (var f in e) {
          if (Kt.call(e, f) && f !== "css" && f !== hn && (true || 0)) {
            c[f] = e[f];
          }
        }
        c.ref = n;
      ...
      var Qo = 0;
      var Ko = { capture: false, passive: false };
      function el(e) {
        var t = e.isEnabled,
        ...
        var l = (0, o.useCallback)(
          function (e) {
            ...
            if (t && $o()) {
              t.addEventListener("touchmove", qo, Ko);
              if (e) {
                e.addEventListener("touchstart", Xo, Ko);
                e.addEventListener("touchmove", Go, Ko);
              }
            }
            Qo += 1;
          },
        ...
        var s = (0, o.useCallback)(
          function (e) {
            ...
            if (t && $o()) {
              t.removeEventListener("touchmove", qo, Ko);
              if (e) {
                e.removeEventListener("touchstart", Xo, Ko);
                e.removeEventListener("touchmove", Go, Ko);
              }
            }
          },
          [r]
          ...
          [
            ...
            },
            {
              ...
              value: function e() {
                ...
                var R = o.createElement(Ka, O({}, d, L), function (e) {
                  var n = e.ref,
                    r = e.placerProps,
                    a = r.placement,
                    s = r.maxHeight;
          ...
          s.lV,
          {
            ...
            onSuccess: (e) => {
              if (e.error) {
                ...
                setTimeout(() => {
                  var t = e.data.links.find((e) => e.rel === "edit").href;
    ...
    16535: (e, t, n) => {
      ...
      var U,
        ...
        J = q
          ...
          : (((U = {})["immer-nothing"] = !0), U),
        Q = q ? Symbol.for("immer-draftable") : "__$immer_draftable",
