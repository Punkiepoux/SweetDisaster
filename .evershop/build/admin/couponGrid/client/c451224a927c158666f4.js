...
(() => {
  var l = {
    ...
    94173: (t, n, r) => {
      "use strict";
      r.r(n);
      r.d(n, { default: () => st, query: () => ut, variables: () => ct });
      var a = r(5556);
      var i = r.n(a);
      var o = r(96540);
      var l = r(72505);
      ...
      x.propTypes = { name: i().string.isRequired, url: i().string.isRequired };
      function N(e) {
      ...
      S.propTypes = { text: i().string.isRequired };
      var A = r(23224);
      var D = r.n(A);
      var _ = r(23678);
      ...
      var Se = 300;
      function Ae(t, n) {
        var r = { config: Oe(Oe({}, J), _e.defaultConfig), l10n: ee };
        ...
        function pe() {
          ...
          if (!a.dateFormat && (a.enableTime || o)) {
            var s = _e.defaultConfig.dateFormat || J.dateFormat;
            i.dateFormat =
              a.noCalendar || o
          ...
          if (a.altInput && (a.enableTime || o) && !a.altFormat) {
            var u = _e.defaultConfig.altFormat || J.altFormat;
            i.altFormat =
              a.noCalendar || o
        ...
        function Re(e, t) {
          if (e !== null && typeof e === "object") {
            ...
            else if (Q.indexOf(e) > -1) r.config[e] = ae(t);
          }
          r.redraw();
          Qe(true);
        }
      ...
      var qe = (e) => (Ye(e) ? e : parseInt(e, 10) || 0);
      var He = (e) => {
        if (Ye(e)) {
          return !e;
        }
      ...
      function Xe(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            !Be(s) && o.createElement(We, { onClick: () => c() })
          ),
          l &&
            o.createElement("div", { className: "field-instruction mt-sm" }, l),
          o.createElement(m.A, { error: i })
      ...
      function et(e) {
        ...
        return o.createElement(
          p,
          Je({}, e, { onChange: d, value: s, error: f ? f.error : undefined })
        );
      }
      et.propTypes = {
        name: i().string.isRequired,
      ...
      function lt(e) {
        ...
        var u = async (e) => {
          ...
          var r = t
            ...
            .map((t) =>
              s().patch(t.updateApi, { status: e, coupon: t.coupon })
            );
          await Promise.all(r);
          l(false);
    ...
    53238: (e, t, n) => {
      ...
      l.propTypes = { newCouponUrl: a().string.isRequired };
      var s =
