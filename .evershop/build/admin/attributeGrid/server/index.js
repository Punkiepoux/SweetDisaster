...
(() => {
  var l = {
    ...
    88557: (t, n, r) => {
      "use strict";
      r.r(n);
      r.d(n, { default: () => st, query: () => lt, variables: () => ut });
      var a = r(5556);
      var i = r.n(a);
      var o = r(96540);
      var s = r(72505);
      ...
      function z(e, t) {
        if (t(e)) return e;
        else if (e.parentNode) return z(e.parentNode, t);
        return undefined;
      }
      function U(e, t) {
      ...
      var H = {
        ...
        K: function (e, t, n) {
          e.setHours(
            (e.getHours() % 12) + 12 * P(new RegExp(n.amPM[1], "i").test(t))
          );
        },
        M: function (e, t, n) {
      ...
      var G = {
        ...
        K: function (e, t) {
          return t.amPM[P(e.getHours() > 11)];
        },
        M: function (e, t) {
          return B(e.getMonth(), true, t);
        },
        S: function (e) {
      ...
      var se = 300;
      function le(t, n) {
        var r = { config: ie(ie({}, D), ce.defaultConfig), l10n: R };
        r.parseDate = $({ config: r.config, l10n: r.l10n });
        r._handlers = [];
        r.pluginElements = [];
        r.loadedPlugins = [];
        r._bind = m;
        r._setHoursFromDate = p;
        r._positionCalendar = _e;
        r.changeMonth = fe;
        r.changeYear = ge;
        r.clear = de;
        r.close = pe;
        ...
        function c(e, t) {
          return (e % 12) + 12 * P(t === r.l10n.amPM[1]);
        }
        function f(e) {
          switch (e % 24) {
            case 0:
        ...
        function h(e, t, n) {
          ...
          r.hourElement.value = I(
            !r.config.time_24hr ? ((12 + e) % 12) + 12 * P(e % 12 === 0) : e
          );
          r.minuteElement.value = I(t);
          if (r.amPM !== undefined)
            r.amPM.textContent = r.l10n.amPM[P(e >= 12)];
          if (r.secondElement !== undefined) r.secondElement.value = I(n);
        }
        function v(e) {
          var t = q(e);
        ...
        function y() {
          ...
          var e = M(ke, 50);
          r._debouncedChange = M(g, se);
          if (r.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent))
            m(r.daysContainer, "mouseover", function (e) {
              if (r.config.mode === "range") xe(q(e));
            });
          m(r._input, "keydown", Ee);
          if (r.calendarContainer !== undefined) {
            m(r.calendarContainer, "keydown", Ee);
          }
        ...
        function x() {
          ...
          r.calendarContainer = Z("div", "flatpickr-calendar");
          r.calendarContainer.tabIndex = -1;
          if (!r.config.noCalendar) {
            e.appendChild(G());
            r.innerContainer = Z("div", "flatpickr-innerContainer");
            ...
            r.rContainer = Z("div", "flatpickr-rContainer");
            r.rContainer.appendChild(ae());
            if (!r.daysContainer) {
              r.daysContainer = Z("div", "flatpickr-days");
          ...
          j(r.calendarContainer, "rangeMode", r.config.mode === "range");
          j(r.calendarContainer, "animate", r.config.animate === true);
          j(r.calendarContainer, "multiMonth", r.config.showMonths > 1);
        ...
        function k(e, t, n, a) {
          ...
          if (r.config.mode === "range") {
            if (Ge(t) && !Ye(t)) o.classList.add("inRange");
          }
          if (
            r.weekNumbers &&
        ...
        function _() {
          ...
          V(r.daysContainer);
          if (r.weekNumbers) V(r.weekNumbers);
        ...
        function L() {
          ...
          for (var t = 0; t < 12; t++) {
            if (!e(t)) continue;
            var n = Z("option", "flatpickr-monthDropdown-month");
            n.value = new Date(r.currentYear, t).getMonth().toString();
            n.textContent = B(t, r.config.shorthandCurrentMonth, r.l10n);
            n.tabIndex = -1;
            if (r.currentMonth === t) {
              n.selected = true;
            }
        ...
        function W() {
          ...
          var o = Z("div", "flatpickr-current-month");
          o.appendChild(n);
          o.appendChild(a);
          t.appendChild(o);
          e.appendChild(t);
        ...
        function G() {
          r.monthNav = Z("div", "flatpickr-months");
          r.yearElements = [];
          r.monthElements = [];
          r.prevMonthNav = Z("span", "flatpickr-prev-month");
          r.prevMonthNav.innerHTML = r.config.prevArrow;
          r.nextMonthNav = Z("span", "flatpickr-next-month");
          ...
          Object.defineProperty(r, "_hidePrevMonthArrow", {
            ...
            set: function (e) {
              if (r.__hidePrevMonthArrow !== e) {
                j(r.prevMonthNav, "flatpickr-disabled", e);
          ...
          Object.defineProperty(r, "_hideNextMonthArrow", {
            ...
            set: function (e) {
              if (r.__hideNextMonthArrow !== e) {
                j(r.nextMonthNav, "flatpickr-disabled", e);
        ...
        function Q() {
          ...
          var e = re(r.config);
          r.timeContainer = Z("div", "flatpickr-time");
          r.timeContainer.tabIndex = -1;
          var t = Z("span", "flatpickr-time-separator", ":");
          var n = U("flatpickr-hour", { "aria-label": r.l10n.hourAriaLabel });
        ...
        function ae() {
          if (!r.weekdayContainer)
            r.weekdayContainer = Z("div", "flatpickr-weekdays");
          else V(r.weekdayContainer);
          for (var e = r.config.showMonths; e--; ) {
        ...
        function le() {
          ...
          var t = oe(r.l10n.weekdays.shorthand);
          if (e > 0 && e < t.length) {
            t = oe(t.splice(e, t.length), t.splice(0, e));
          }
        ...
        function ue() {
          ...
          e.appendChild(
            Z("span", "flatpickr-weekday", r.l10n.weekAbbreviation)
          );
        ...
        function xe(e, t) {
          ...
          f.forEach(function (t) {
            ...
            if (e !== undefined) {
              ...
              if (o >= l && (u === 0 || o <= u) && K(o, a, n))
                t.classList.add("inRange");
            }
          });
        }
        function ke() {
          if (r.isOpen && !r.config.static && !r.config.inline) _e();
        }
        function Ce(e, t) {
          if (t === void 0) {
        ...
        function Oe() {
          ...
          var a = ie(ie({}, JSON.parse(JSON.stringify(t.dataset || {}))), n);
          var i = {};
          ...
          if (!a.dateFormat && (a.enableTime || o)) {
            var l = ce.defaultConfig.dateFormat || D.dateFormat;
            i.dateFormat =
              a.noCalendar || o
          ...
          if (a.altInput && (a.enableTime || o) && !a.altFormat) {
            var u = ce.defaultConfig.altFormat || D.altFormat;
            i.altFormat =
              a.noCalendar || o
          ...
          for (var f = 0; f < r.config.plugins.length; f++) {
            ...
            for (var p in d) {
              if (A.indexOf(p) > -1) {
                r.config[p] = F(d[p]).map(s).concat(r.config[p]);
              } else if (typeof a[p] === "undefined") r.config[p] = d[p];
            }
          }
          if (!a.altInputClass) {
            r.config.altInputClass =
              Se().className + " " + r.config.altInputClass;
          }
          Be("onParseConfig");
        }
        function Se() {
        ...
        function Te() {
          if (
            ...
            typeof ce.l10ns[r.config.locale] === "undefined"
          )
          ...
          r.l10n = ie(
            ...
            typeof r.config.locale === "object"
              ...
              ? ce.l10ns[r.config.locale]
              : undefined
          );
          Y.D = "(" + r.l10n.weekdays.shorthand.join("|") + ")";
          Y.l = "(" + r.l10n.weekdays.longhand.join("|") + ")";
          Y.M = "(" + r.l10n.months.shorthand.join("|") + ")";
          Y.F = "(" + r.l10n.months.longhand.join("|") + ")";
          Y.K =
            "(" +
            r.l10n.amPM[0] +
            "|" +
            ...
            ")";
          var e = ie(ie({}, n), JSON.parse(JSON.stringify(t.dataset || {})));
          if (
            e.time_24hr === undefined &&
            ce.defaultConfig.time_24hr === undefined
          ) {
        ...
        function _e(e) {
          ...
          j(r.calendarContainer, "arrowTop", !c);
          j(r.calendarContainer, "arrowBottom", c);
          ...
          j(r.calendarContainer, "arrowLeft", !p && !h);
          j(r.calendarContainer, "arrowCenter", p);
          j(r.calendarContainer, "arrowRight", h);
          var v =
          ...
          j(r.calendarContainer, "rightMost", m);
          ...
          if (!m) {
            ...
            j(r.calendarContainer, "rightMost", false);
            j(r.calendarContainer, "centerMost", true);
        ...
        function Me(e, t) {
          if (e !== null && typeof e === "object") {
            ...
            else if (A.indexOf(e) > -1) r.config[e] = F(t);
          }
          r.redraw();
          Je(true);
        }
        ...
        function ze() {
          ...
          if (r.config.altInput) {
            r.altInput = Z(r.input.nodeName, r.config.altInputClass);
            r._input = r.altInput;
        ...
        function qe() {
          var e = r.config.enableTime
            ? r.config.noCalendar
              ...
              : "datetime-local"
            : "date";
          r.mobileInput = Z("input", r.input.className + " flatpickr-mobile");
          ...
          m(r.mobileInput, "change", function (e) {
            r.setDate(q(e).value, false, r.mobileFormatStr);
            Be("onChange");
            Be("onClose");
          });
        }
          ...
          r.yearElements.forEach(function (e, t) {
            ...
            if (
              ...
              r.monthElements[t].textContent =
                B(n.getMonth(), r.config.shorthandCurrentMonth, r.l10n) + " ";
            } else {
        ...
        function Ke(e) {
          ...
          if (r.amPM !== undefined && n === r.amPM) {
            r.amPM.textContent =
              r.l10n.amPM[P(r.amPM.textContent === r.l10n.amPM[0])];
          }
          ...
          if (typeof a.value !== "undefined" && a.value.length === 2) {
            var f = a === r.hourElement,
              d = a === r.minuteElement;
            if (c < i) {
              c = o + c + P(!f) + (P(f) && P(!r.amPM));
              if (d) E(undefined, -1, r.hourElement);
            } else if (c > o) {
              c = a === r.hourElement ? c - o - P(!r.amPM) : i;
              if (d) E(undefined, 1, r.hourElement);
            }
      ...
      var ce = function (e, t) {
        if (typeof e === "string") {
          return ue(window.document.querySelectorAll(e), t);
      ...
      ce.defaultConfig = {};
      ce.l10ns = { en: ie({}, R), default: ie({}, R) };
      ce.localize = function (e) {
        ce.l10ns.default = ie(ie({}, ce.l10ns.default), e);
      };
      ce.setDefaults = function (e) {
        ce.defaultConfig = ie(ie({}, ce.defaultConfig), e);
      };
      ce.parseDate = $({});
      ce.formatDate = X({});
      ce.compareDates = J;
      ...
      ve.defaultProps = { value: undefined, error: undefined };
            ...
            l.map((e, n) =>
              o.createElement(
                ...
                o.createElement(
                  ...
                  u == e.value && o.createElement(ge, null),
                  u != e.value && o.createElement(ye, null),
      ...
      Ee.propTypes = { onClick: i().func.isRequired };
      function xe(e) {
        var { onClick: t } = e;
        return o.createElement(
          "a",
      ...
      xe.propTypes = { onClick: i().func.isRequired };
      var ke = (e) => typeof e === "boolean";
      var Ce = (e) => (ke(e) ? e : parseInt(e, 10) === 1);
      var Ne = (e) => (ke(e) ? e : parseInt(e, 10) || 0);
      var Oe = (e) => {
        if (ke(e)) {
          return !e;
        }
      ...
      function Se(e) {
        ...
        return o.createElement(
          ...
          { className: "form-field-container ".concat(i ? "has-error" : null) },
          r && o.createElement("label", { htmlFor: t }, r),
          o.createElement("input", { type: "hidden", value: +Ne(l), name: t }),
          o.createElement(
            "div",
            { className: "field-wrapper flex flex-grow" },
            Ce(l) && o.createElement(Ee, { onClick: () => c() }),
            !Ce(l) && o.createElement(xe, { onClick: () => c() })
          ),
          s &&
            o.createElement("div", { className: "field-instruction mt-sm" }, s),
          o.createElement(v.A, { error: i })
      ...
      var Te = r(23678);
      const _e = "FORM_VALIDATED";
      const Ae = "FORM_SUBMIT";
      const De = "FORM_FIELD_UPDATED";
      var Le = r(31021);
      var Re = r(64600);
      const Ie = {};
      const Pe = {
      ...
      function qe(e) {
        ...
        var N = () => {
          ...
          if (Object.keys(e).length === 0) {
            m(v.map((e) => Fe(Fe({}, e), {}, { error: undefined })));
          } else {
            m(
              v.map((t) => {
                if (!e[t.name]) {
                  return Fe(Fe({}, t), {}, { error: undefined });
                }
                return Fe(Fe({}, t), {}, { error: e[t.name] });
              })
            );
          }
          return e;
        ...
        var O = async (o) => {
          ...
          E("submitting");
          try {
            S().publishSync(Ae, { props: e });
            var f = N();
            S().publishSync(_e, { formId: t, errors: f });
            if (Object.keys(f).length === 0) {
              ...
              var p = await fetch(n, {
                ...
                body:
                  a === true
                    ? JSON.stringify((0, Le.serializeForm)(d.entries(), h))
                    : d,
                headers: Fe(
              ...
              var v = await p.json();
              if ((0, Te.get)(v, "data.redirectUrl") !== undefined) {
      ...
      var We = () => o.useContext(ze);
      var Be = () => React.useContext(Ue);
      function He() {
        return (
          (He = Object.assign
            ? Object.assign.bind()
      ...
      function Je(e) {
        ...
        o.useEffect(() => {
          S().publishSync(De, { name: t, value: l });
        }, [l]);
        var d = (n) => {
          var i;
        ...
        return o.createElement(
          p,
          Xe({}, e, { onChange: d, value: l, error: f ? f.error : undefined })
        );
      }
      Je.propTypes = {
        name: i().string.isRequired,
      ...
      Je.defaultProps = { onChange: undefined, validationRules: [], value: "" };
      function Qe(e) {
        var { groups: t } = e;
        var { openAlert: n, closeAlert: r, dispatchAlert: a } = (0, b.Z)();
        var i = (e) => {
          n({
            heading: "Editing ".concat(e.groupName),
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              parseInt(n.row[t], 10) === 0 &&
                o.createElement("span", null, "No"),
              parseInt(n.row[t], 10) === 1 &&
                o.createElement("span", null, "Yes")
            )
          )
        );
      }
      et.propTypes = {
        areaProps: i().shape({
          row: i().objectOf(i().oneOfType([i().string, i().number])),
        }).isRequired,
        id: i().string.isRequired,
      };
      function tt() {
      ...
      it.propTypes = { title: i().string.isRequired };
      function ot(t) {
        var { attributes: n = [], selectedIds: r = [] } = t;
        var { openAlert: a, closeAlert: i } = (0, b.Z)();
        var [s, u] = (0, o.useState)(false);
        var c = async () => {
          u(true);
          try {
            var t = n
              .filter((e) => r.includes(e.uuid))
              .map((e) =>
                l()["delete"](e.deleteApi, { validateStatus: () => true })
              );
            var a = await Promise.allSettled(t);
            u(false);
            a.forEach((e) => {
              var { status: t } = e.value;
              if (t !== 200) {
                throw new Error(e.value.data.error.message);
              }
            });
            window.location.reload();
          } catch (e) {
        ...
        var f = [
          {
            ...
            onAction: () => {
              a({
                heading: "Delete ".concat(r.length, " attributes"),
      ...
      function st(e) {
        var t;
        var {
          attributes: { items: n, total: r, currentFilters: a = [] },
        } = e;
          ...
          o.createElement(k.Z.Session, {
            title: o.createElement(
              ...
              o.createElement(Je, {
                ...
                placeholder: "Search",
                value:
                  (t = a.find((e) => e.key === "name")) === null || t === void 0
                    ? void 0
                    : t.value,
                onKeyPress: (e) => {
                  if (e.key === "Enter") {
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement(x, {
                    onChange: (e) => {
                      if (e.target.checked) c(n.map((e) => e.uuid));
                      else c([]);
                    },
                  })
                ),
                o.createElement(u.A, {
                  ...
                  coreComponents: [
                    ...
                    {
                      component: {
                        default: () => o.createElement(it, { title: "Groups" }),
                      },
                      sortOrder: 15,
                    },
                    {
      ...
      st.propTypes = {
        attributes: i().shape({
          items: i().arrayOf(
            i().shape({
              uuid: i().string.isRequired,
              attributeId: i().number.isRequired,
              attributeName: i().string.isRequired,
              attributeCode: i().string.isRequired,
              type: i().string.isRequired,
              isRequired: i().bool.isRequired,
              isFilterable: i().bool.isRequired,
    ...
    20348: (e, t, n) => {
      ...
      const c = u;
      function f() {
        return r.createElement(c, { backUrl: null, heading: "Attributes" });
      }
    },
    83482: (e, t, n) => {
      "use strict";
      ...
      var o = n(64600);
      function s(e) {
        var { newAttributeUrl: t } = e;
        return i.createElement(o.A, { url: t, title: "New Attribute" });
      }
      s.propTypes = { newAttributeUrl: a().string.isRequired };
      var l =
    ...
    87960: (e, t, n) => {
      ...
      e.exports = function e(t) {
        return new Promise(function e(n, y) {
          ...
          var L = m.test(T);
          var R = L ? t.httpsAgent : t.httpAgent;
          var I = {
          ...
          if (!P && P !== false) {
            ...
            if (F) {
              ...
              var V = true;
              if (Z) {
                var z = Z.split(",").map(function e(t) {
                  return t.trim();
                });
                V = !z.some(function e(t) {
                  if (!t) {
                    return false;
                  }
                  if (t === "*") {
          ...
          var q;
          var W = L && (P ? m.test(P.protocol) : true);
          if (t.transport) {
            q = t.transport;
          ...
          var B = q.request(I, function e(n) {
            if (B.aborted) return;
            var i = n;
            var o = n.req || B;
            if (
    ...
    6513: (e, t, n) => {
      ...
      for (var L = new Uint16Array(16), R = 0; 15 > R; R++) L[R] = R + 1;
      L[15] = 0;
      var I =
      ...
      var X = "function" === typeof Object.is ? Object.is : G,
        $ = null,
        J = null,
        Q = null,
        K = !1,
    ...
    22551: (t, r, i) => {
      ...
      var Sn = {
        ...
        In = s({}, _n, {
          ...
          movementX: function (e) {
            ...
            e !== Rn &&
              (Rn && "mousemove" === e.type
                ? ((Dn = e.screenX - Rn.screenX), (Ln = e.screenY - Rn.screenY))
                : (Ln = Dn = 0),
              (Rn = e));
            return Dn;
          },
        ...
        Zn = On(jn),
        Vn = s({}, Sn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
        zn = On(Vn),
        Un = s({}, Sn, {
      ...
      function $i(e, t, n, r) {
        ...
        "object" === typeof i && null !== i
          ? (a.context = Pi(i))
          : ((i = Ha(t) ? Wa : Ua.current), (a.context = Ba(e, i)));
        Ui(e, n, a, r);
        a.state = e.memoizedState;
      ...
      var ss = {
        ...
        ls = {
          ...
          useImperativeHandle: function (e, t, n) {
            n = null !== n && void 0 !== n ? n.concat([e]) : null;
            return Xo(4, 2, es.bind(null, t, e), n);
          },
      ...
      function Fs(e, t, n) {
        ...
        switch (t.tag) {
          ...
          case 4:
            return (
              uo(), Rs(t), null === e && oa(t.stateNode.containerInfo), null
            );
          case 10:
            return Li(t), null;
          case 17:
      ...
      function qs(e, t, n) {
        ...
        null !== i &&
          ...
          (n.callback = function () {
            "function" !== typeof r &&
              (null === Sl ? (Sl = new Set([this])) : Sl.add(this), Vs(e, t));
            var n = t.stack;
        ...
        for (var n = t, r = !1, a, i; ; ) {
          ...
          if (5 === n.tag || 6 === n.tag) {
            e: for (var o = e, s = n, l = s; ; )
              if ((Xs(o, l), null !== l.child && 4 !== l.tag))
      ...
      function nl(e, t) {
        switch (t.tag) {
          ...
          case 12:
            return;
          case 13:
            null !== t.memoizedState && ((El = yi()), Gs(t.child, !0));
            rl(t);
            return;
          case 19:
            rl(t);
      ...
      function ql(e, t, n) {
        if (50 < Il) throw ((Il = 0), (Pl = null), Error(u(185)));
        e = Wl(e, t);
        if (null === e) return null;
        sn(e, t, n);
      ...
      function uu(e, t) {
        ...
        null !== Rl && 0 === (r & 24) && Rl.has(e) && Rl.delete(e);
      ...
      function cu() {
        for (; null !== Cl; ) {
          ...
          Vl ||
            ...
            (0 !== (Cl.flags & 8)
              ? pt(Cl, Zl) && (Vl = !0)
              : 13 === Cl.tag && al(e, Cl) && pt(Cl, Zl) && (Vl = !0));
          var t = Cl.flags;
          0 !== (t & 256) && Hs(e, Cl);
          0 === (t & 512) ||
            Tl ||
      ...
      function Nu(e, t, n, r, a, i) {
        ...
        if ("function" === typeof e) xu(e) && (o = 1);
          ...
          e: switch (e) {
            ...
            case V:
              return (
                (e = Eu(19, n, t, a)), (e.elementType = V), (e.lanes = i), e
              );
            case Y:
              return Su(n, a, i, t);
            case G:
      ...
      var Uu = { Events: [La, Ra, Ia, ze, Ue, fu, { current: !1 }] },
        qu = {
      ...
      var Wu = {
        ...
        findFiberByHostInstance: qu.findFiberByHostInstance || Mu,
    ...
    66474: (e, t, n) => {
      ...
      R.defaultProps = { type: x.DEFAULT, hide: false };
      var I = function e(t) {
        var n;
        var a = D(t),
          i = a.isRunning,
      ...
      function Q(e, t) {
        if (Y()) {
          ...
          if (H && b) {
            ...
            (0, l.render)((0, r.createElement)(V, Object.assign({}, W)), q);
          }
        }
        return t.toastId;
      }
    ...
    7463: (e, t) => {
      ...
      t.unstable_scheduleCallback = function (e, i, o) {
        ...
        o > s
          ...
          : ((e.sortIndex = l), k(S, e), R || L || ((R = !0), n(F)));
        return e;
      };
    ...
    68963: (l, f, p) => {
      ...
      function $(e, t) {
        let n = 0;
        let r = 1;
        for (const a of e.body.matchAll(X)) {
      ...
      function Le(e, t) {
        return Re(e.charCodeAt(t)) && Ie(e.charCodeAt(t + 1));
      }
      function Re(e) {
      ...
      const Xe = globalThis.process && "production" === "production";
      const $e = Xe
        ? function e(t, n) {
      ...
      class rt {
        ...
        node(e, t) {
          if (this._options.noLocation !== true) {
            t.loc = new I(e, this._lexer.lastToken, this._lexer.source);
          }
          return t;
        }
        peek(e) {
      ...
      var er = ({ forward: e, client: t, dispatchDebug: n }) => {
        ...
        return (n) => {
          ...
          var l = yt((e) => {
            ...
            var a = {
              ...n,
              operation: Xn(e, { cacheOutcome: n ? "hit" : "miss" }),
            };
        ...
        var s =
          ...
          (l) => {
            ...
            var d = x((e) => {
              ...
              return { ...i, operation: Xn(e, { cacheOutcome: "hit" }) };
            })(
              w(
