...
(() => {
  var p = {
    ...
    31054: (e, t, n) => {
      ...
      o.propTypes = { url: i().string, name: i().string };
        ...
        return a.createElement(
          ...
          n &&
            a.createElement(
              "a",
              { href: t },
              a.createElement("img", { src: n, alt: r })
            ),
          !n &&
            a.createElement(
              "a",
      ...
      u.propTypes = { alt: i().string, imageUrl: i().string, url: i().string };
      u.defaultProps = { alt: "", imageUrl: "", url: "" };
      function c(e) {
      ...
      c.propTypes = {
        regular: i().shape({ value: i().number, text: i().string }).isRequired,
        special: i().shape({ value: i().number, text: i().string }).isRequired,
      };
      var f = n(5806);
      var d = n(23678);
      var p = n(72873);
      ...
      function b(e) {
        var { products: t = [], countPerRow: n = 3 } = e;
        if (t.length === 0) {
          return a.createElement(
            "div",
            ...
            a.createElement(
              "div",
              { className: "text-center" },
              (0, p._)("There is no product to display")
            )
          );
        }
        var r;
        switch (n) {
          case 3:
            r = "grid grid-cols-2 md:grid-cols-3 gap-2";
            break;
          case 4:
            r = "grid grid-cols-2 md:grid-cols-4 gap-2";
            break;
          case 5:
            r = "grid grid-cols-2 md:grid-cols-5 gap-2";
            break;
          default:
            r = "grid grid-cols-2 md:grid-cols-3 gap-2";
        }
      ...
      b.propTypes = {
        products: i().arrayOf(
          i().shape({
            ...
            url: i().string,
            price: i().shape({
              regular: i().shape({ value: i().number, text: i().string }),
              special: i().shape({ value: i().number, text: i().string }),
            }),
            image: i().shape({ alt: i().string, listing: i().string }),
          })
        ).isRequired,
        countPerRow: i().number.isRequired,
      };
      function E(e) {
        var { collection: t } = e;
        if (!t) {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(b, { products: t.products.items, countPerRow: 4 })
          )
        );
      }
      E.propTypes = {
    ...
    11754: (e, t, n) => {
      ...
      var i = n(72873);
      function a() {
        var e = (0, i._)("Discount ${discount} For All Orders Over ${price}", {
          discount: "20%",
          price: "$2000",
        });
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement("h2", { className: "h1 " }, e),
              r.createElement(
                "p",
                null,
                "Use coupon code",
              ...
              r.createElement(
                "p",
                null,
                (0, i._)("Use coupon ${coupon}", { coupon: "DISCOUNT20" })
              ),
    ...
    22551: (t, r, i) => {
      ...
      function T(e, t, n, r) {
        if (null === t || "undefined" === typeof t || O(e, t, n, r)) return !0;
        if (r) return !1;
        if (null !== n)
          switch (n.type) {
            case 3:
      ...
      var Ce,
        _e = (function (e) {
          ...
          if (e.namespaceURI !== Oe.svg || "innerHTML" in e) e.innerHTML = t;
          else {
            Ce = Ce || document.createElement("div");
            Ce.innerHTML = "<svg>" + t.valueOf().toString() + "</svg>";
            for (t = Ce.firstChild; e.firstChild; ) e.removeChild(e.firstChild);
      ...
      function Pt(e, t, n, r, i) {
        switch (t) {
          ...
          case "pointerover":
            var a = i.pointerId;
            Ot.set(a, At(Ot.get(a) || null, e, t, n, r, i));
            return !0;
          case "gotpointercapture":
            return (
              (a = i.pointerId),
      ...
      function bn(e, t, n, r) {
        if (mn) {
          var i;
          if ((i = 0 === (t & 4)) && 0 < wt.length && -1 < Ct.indexOf(e))
      ...
      var _n = {
        ...
        zn = Cn(Fn),
        Un = s({}, An, { relatedTarget: 0 }),
        Zn = Cn(Un),
        Vn = s({}, _n, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
        Bn = Cn(Vn),
        qn = s({}, _n, {
      ...
      var Jn = s({}, An, {
        ...
        ir = Cn(rr),
        ar = s({}, _n, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
        or = Cn(ar),
        lr = s({}, Mn, {
          deltaX: function (e) {
            return "deltaX" in e
      ...
      if (g) {
        ...
        _r = Lr && (!document.documentMode || 9 < document.documentMode);
      }
      function Ir() {
        Nr && (Nr.detachEvent("onpropertychange", Rr), (Or = Nr = null));
      }
      function Rr(e) {
      ...
      function Dr(e, t, n) {
        "focusin" === e
          ? (Ir(), (Nr = t), (Or = n), Nr.attachEvent("onpropertychange", Rr))
          : "focusout" === e && Ir();
      }
      function Mr(e) {
      ...
      function Ta() {
        if (!ga && null !== ma) {
          ...
          try {
            ...
            throw (null !== ma && (ma = ma.slice(e + 1)), ra(ua, Oa), c);
          } finally {
            ga = !1;
          }
        }
      }
      var Sa = P.ReactCurrentBatchConfig;
      function Ca(e, t) {
        if (e && e.defaultProps) {
          t = s({}, t);
          e = e.defaultProps;
      ...
      function Ga(e, t, n) {
        ...
        "object" === typeof a && null !== a
          ? (a = ja(a))
          : ((i = Hi(t) ? Xi : qi.current),
            (r = t.contextTypes),
            (a = (r = null !== r && void 0 !== r) ? Yi(e, i) : Bi));
        t = new t(n, a);
        e.memoizedState =
      ...
      function Ka(e, t, n, r) {
        ...
        "object" === typeof a && null !== a
          ? (i.context = ja(a))
          : ((a = Hi(t) ? Xi : qi.current), (i.context = Yi(e, a)));
        qa(e, n, i, r);
        i.state = e.memoizedState;
      ...
      function no(e) {
        ...
        function c(e, t, n, r, a) {
          if (null === t || 7 !== t.tag)
            return (t = Cu(n, e.mode, r, a)), (t.return = e), t;
          t = i(t, n);
          t.return = e;
          return t;
        }
        function f(e, t, n) {
          ...
          if ("object" === typeof t && null !== t) {
            ...
            if (Ja(t) || J(t))
              return (t = Cu(t, e.mode, n, null)), (t.return = e), t;
            to(e, t);
          }
          return null;
        }
            ...
            switch (a.$$typeof) {
              case I:
                e: {
                  ...
                  a.type === D
                    ? ((r = Cu(a.props.children, e.mode, l, a.key)),
                      (r.return = e),
                      (e = r))
      ...
      var Co = P.ReactCurrentDispatcher,
        _o = P.ReactCurrentBatchConfig,
        Lo = 0,
        Ao = null,
        Po = null,
        Io = null,
      ...
      function Fo(e, t, n, r, i, a) {
        ...
        t.updateQueue = null;
        t.lanes = 0;
        Co.current = null === e || null === e.memoizedState ? cl : fl;
        e = n(r, i);
        if (Do) {
          a = 0;
          do {
      ...
      function kl(e, t, n, r, i) {
        ...
        if (null === t.stateNode)
          ...
          l !== r || d !== s || Wi.current || Fa
            ? ("function" === typeof c &&
                (Ya(t, n, c, r), (s = t.memoizedState)),
              (l = Fa || $a(t, n, l, r, d, s, u))
                ? (f ||
          ...
          Ua(e, t);
          l = t.memoizedProps;
          u = t.type === t.elementType ? l : Ca(t.type, l);
          o.props = u;
          f = t.pendingProps;
          d = o.context;
          s = n.contextType;
          ...
          l !== f || d !== v || Wi.current || Fa
            ? ("function" === typeof p &&
                (Ya(t, n, p, r), (v = t.memoizedState)),
              (u = Fa || $a(t, n, u, r, d, v, s))
                ? (c ||
      ...
      var Ol = { dehydrated: null, retryLane: 0 };
      function Tl(e, t, n) {
        var r = t.pendingProps,
          i = ho.current,
          a = !1,
        ...
        if (null === e) {
          ...
          n = _u({ mode: "visible", children: e }, t.mode, n, null);
          n.return = t;
          return (t.child = n);
        }
        if (null !== e.memoizedState) {
          if (a)
            return (
              (r = _l(e, t, r.children, r.fallback, n)),
              (a = t.child),
      ...
      function Cl(e, t, n, r) {
        var i = e.child;
        e = i.sibling;
        n = Tu(i, { mode: "visible", children: n });
      ...
      function _l(e, t, n, r, i) {
        ...
        0 === (a & 2) && t.child !== o
          ...
          : (n = Tu(o, l));
        null !== e ? (r = Tu(e, r)) : ((r = Cu(r, a, i, null)), (r.flags |= 2));
        r.return = t;
        n.return = t;
        n.sibling = r;
        t.child = n;
                ...
                for (a in l)
                  if (l.hasOwnProperty(a)) {
                    ...
                    "style" === a
                      ...
                      ? ((u = u ? u.__html : void 0), null != u && _e(e, u))
                      : "children" === a
                      ? "string" === typeof u
                        ? ("textarea" !== n || "" !== u) && Le(e, u)
      ...
      function Wl(e, t, n) {
        ...
        null !== a &&
          ...
          (n.callback = function () {
            "function" !== typeof r &&
              (null === _s ? (_s = new Set([this])) : _s.add(this), Vl(e, t));
            var n = t.stack;
      ...
      function is(e, t) {
        switch (t.tag) {
          ...
          case 12:
            return;
          case 13:
            null !== t.memoizedState && ((xs = Ea()), Gl(t.child, !0));
            as(t);
            return;
          case 19:
            as(t);
      ...
      function Ys(e, t) {
        ...
        if (0 === r)
          ...
          15 === t
            ? ((n = Gs.bind(null, e)),
              null === ma ? ((ma = [n]), (ya = ra(ua, Ta))) : ma.push(n),
              (n = va))
            : 14 === t
            ? (n = Na(99, Gs.bind(null, e)))
      ...
      function Hs(e) {
        ...
        if (0 !== (gs & Es)) nu(e, 0);
          ...
          2 === r &&
            ...
            (n = an(e)),
            0 !== n && (r = au(e, n)));
          if (1 === r) throw ((t = ys), nu(e, 0), $s(e, n), Ys(e, Ea()), t);
      ...
      function Gs(e) {
        ...
        0 !== e.tag &&
          ...
          (t = an(e)),
          0 !== t && (n = au(e, t)));
        if (1 === n) throw ((n = ys), nu(e, 0), $s(e, t), Ys(e, Ea()), n);
        e.finishedWork = e.current.alternate;
        e.finishedLanes = t;
        cu(e);
        Ys(e, Ea());
      ...
      function fu(e, t) {
        ...
        if (Ls) (Ls = !1), (As = e), (Ps = t);
          ...
          for (Ts = r; null !== Ts; )
            (t = Ts.nextEffect),
              (Ts.nextEffect = null),
              Ts.flags & 8 &&
                ((x = Ts), (x.sibling = null), (x.stateNode = null)),
              (Ts = t);
        r = e.pendingLanes;
        0 === r && (_s = null);
        ...
        Ys(e, Ea());
        if (Ss) throw ((Ss = !1), (e = Cs), (Cs = null), e);
      ...
      function du() {
        for (; null !== Ts; ) {
          ...
          Vs ||
            ...
            (0 !== (Ts.flags & 8)
              ? ht(Ts, Zs) && (Vs = !0)
              : 13 === Ts.tag && os(e, Ts) && ht(Ts, Zs) && (Vs = !0));
          var t = Ts.flags;
          0 !== (t & 256) && Hl(e, Ts);
          0 === (t & 512) ||
            Ls ||
      ...
      function Su(e, t, n, r, i, a) {
        ...
        if ("function" === typeof e) Nu(e) && (o = 1);
          ...
          e: switch (e) {
            ...
            case G:
              return (
                (e = xu(24, n, t, i)), (e.elementType = G), (e.lanes = a), e
              );
            default:
      ...
      function C(e) {
        ...
        (0, r.useEffect)(
          function () {
            ...
            O.emit(4, a.length, e.containerId);
          },
          [a]
        );
        (0, r.useEffect)(function () {
        ...
        function _(e, t) {
          ...
          if (a.closeButton === false || E(a.closeButton)) {
            ...
            O = E(m.closeButton) ? m.closeButton : true;
          }
          N.closeButton = O;
          var T = e;
      ...
      ee.update = function (e, t) {
        ...
        setTimeout(function () {
          ...
          if (n) {
            var r = n.props,
              i = n.content;
            var a = u({}, r, t, { toastId: t.toastId || e, updateId: G() });
      ...
      function L(e, t, n, r, o) {
        ...
        if (Array.isArray(e))
          ...
          for (e = c.call(e), u = 0; !(l = e.next()).done; )
            (l = l.value), (c = r + _(l, u++)), (s += L(l, t, n, c, o));
        else if ("object" === l)
          throw (
            ((t = "" + e),
            Error(
    ...
    7463: (e, t) => {
      ...
      function D(e) {
        for (var t = N(C); null !== t; ) {
          if (null === t.callback) O(C);
            ...
            O(C), (t.sortIndex = t.expirationTime), x(S, t);
          else break;
          t = N(C);
        }
      }
        ...
        try {
          ...
          for (
            ...
            if ("function" === typeof o) {
              ...
              n = t.unstable_now();
              "function" === typeof l ? (L.callback = l) : L === N(S) && O(S);
              D(n);
            } else O(S);
            L = N(S);
          }
      ...
      t.unstable_scheduleCallback = function (e, a, o) {
        ...
        o > l
          ? ((e.sortIndex = o),
            x(C, e),
            null === N(S) && e === N(C) && (R ? i() : (R = !0), r(M, o - l)))
          : ((e.sortIndex = s), x(S, e), I || P || ((I = !0), n(j)));
        return e;
      };
    ...
    16535: (e, t, n) => {
      ...
      var W,
        ...
        Q = Y
          ...
          : (((W = {})["immer-nothing"] = !0), W),
        K = Y ? Symbol.for("immer-draftable") : "__$immer_draftable",
        J = Y ? Symbol.for("immer-state") : "__$immer_state",
  ...
  (() => {
    ...
    function X(e, t, n = U) {
      ...
      do {
        ...
        if (!Array.isArray(u)) {
          var v, h;
          V(u) || T(false, `Invalid AST Node: ${_(u)}.`);
          const n = e
    ...
    const xe = {
      ...
      OperationDefinition: {
        leave(e) {
          const t = Te("(", Ne(e.variableDefinitions, ", "), ")");
          const n = Ne(
      ...
      SelectionSet: { leave: ({ selections: e }) => Oe(e) },
      Field: {
        leave({
          alias: e,
          name: t,
      ...
      FragmentSpread: {
        leave: ({ name: e, directives: t }) => "..." + e + Te(" ", Ne(t, " ")),
      },
      InlineFragment: {
      ...
      ObjectTypeDefinition: {
        leave: ({
          ...
          Te("", e, "\n") +
          Ne(
            ["type", t, Te("implements ", Ne(n, " & ")), Ne(r, " "), Oe(i)],
            " "
          ),
      },
      FieldDefinition: {
      ...
      UnionTypeExtension: {
        leave: ({ name: e, directives: t, types: n }) =>
          Ne(["extend union", e, Ne(t, " "), Te("= ", Ne(n, " | "))], " "),
      },
      EnumTypeExtension: {
        leave: ({ name: e, directives: t, values: n }) =>
          Ne(["extend enum", e, Ne(t, " "), Oe(n)], " "),
      },
      InputObjectTypeExtension: {
        leave: ({ name: e, directives: t, fields: n }) =>
          Ne(["extend input", e, Ne(t, " "), Oe(n)], " "),
      },
    };
    function Ne(e, t = "") {
      var n;
    ...
    function Ge(e, t) {
      ...
      throw _e(e.source, a, "Unterminated string.");
    }
    function Qe(e, t) {
      const n = e.source.body;
      const r = n.length;
    ...
    class et {
      constructor(e, t = "GraphQL request", n = { line: 1, column: 1 }) {
        typeof e === "string" ||
          T(false, `Body must be a string. Received: ${_(e)}.`);
        this.body = e;
        this.name = t;
    ...
    class ot {
      ...
      unexpected(e) {
        ...
        return _e(this._lexer.source, t.start, `Unexpected ${lt(t)}.`);
      }
      any(e, t, n) {
        this.expectToken(e);
        const r = [];
    ...
    var xn = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g;
    var Nn = /(#[^\n\r]+)?(?:\n|\r\n?|$)+/g;
    var On = (e, t) => (t % 2 == 0 ? e.replace(Nn, "\n") : e);
    var Tn = (e) => e.split(xn).map(On).join("").trim();
    var Sn = new Map();
    var Cn = new Map();
    var _n = (e) => {
      var t;
    ...
    var hr = function e(t) {
      ...
      var p = Object.assign(d, {
        ...
        query(e, t, n) {
          ...
          return Gn(p.executeQuery(Pn(e, t), n));
        },
        readQuery(e, t, n) {
          var r = null;
          tn((e) => {
        ...
        mutation: (e, t, n) => Gn(p.executeMutation(Pn(e, t), n)),
      });
      var v = Jn;
      if (false) {
        var h, m;
    ...
    function Lr(e) {
      ...
      var [m, y] = u(() => [c, Tr(Or, p(c, r)), h]);
      var g = m[1];
      if (c !== m[0] && Sr(m[2], h)) {
        y([c, (g = Tr(m[1], p(c, r))), h]);
      }
      o(() => {
        var e = m[0];
        var t = m[2][1];
    ...
    function Ar(e, t) {
      ...
      var [p, h] = u(() => [c, { ...Or, fetching: !!c }, f]);
      var m = p[1];
      if (c !== p[0] && Sr(p[2], f)) {
        h([c, (m = Tr(p[1], { fetching: !!c })), f]);
      }
      o(() => {
        var e = (e) => {
          h((t) => {
    ...
    var Xr = p.createContext();
    var Yr = () => React.useContext(Xr);
    function Hr(e, t) {
      switch (t.type) {
        case "close":
          return Vr(Vr({}, e), {}, { showing: false, closing: false });
        case "closing":
          return Vr(Vr({}, e), {}, { showing: true, closing: true });
        case "open":
          return Vr(Vr({}, e), {}, { showing: true, closing: false });
        default:
          throw new Error();
      }
    }
    ...
    Gr.propTypes = { children: gr().node.isRequired };
    function Qr(e) {
      var { client: t } = e;
      return p.createElement(
        wr,
    ...
    var Kr = mr({ url: "/api/graphql" });
    function Jr() {
      return p.createElement(Qr, { client: Kr });
    }
